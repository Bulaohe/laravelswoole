...
return [
    ...
    'base_config' => [
        ...
        'port' => env('SWOOLE_PORT', 9050),

        // this file storages the pid of laravoole
        'pid_file' => env('SWOOLE_PID_FILE', storage_path('/logs/laravoole.pid')),
        ...
        'deal_with_public' => env('SWOOLE_DEAL_WITH_PUBLIC', false),

        // enable gzip
        'gzip' => extension_loaded('zlib') && env('SWOOLE_GZIP', 1),

        'gzip_min_length' => env('SWOOLE_GZIP_MIN_LENGTH', 1024),
        ...
        'server' => env('SWOOLE_SERVER', 'Laravelswoole'),
    ...
    'wrapper_config' => [
        ...
        'websocket_default_protocol' => env('SWOOLE_WEBSOCKET_DEFAULT_PROTOCOL', 'jsonrpc'),
